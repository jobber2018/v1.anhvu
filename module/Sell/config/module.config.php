...
return [
    'router' => [
        'routes' => [
            ...
            'sell-staff' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/staff/sell[/:action[/:id]].html',
                    'defaults' => [
            ...
            'sell-user' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/user/sell[/:action[/:id]].html',
                    'defaults' => [
    ...
    'service_manager'=>[
        'factories' => [
            Service\SellManager::class  => Service\Factory\SellManagerFactory::class,
        ]
    ],
    'translator' => [
