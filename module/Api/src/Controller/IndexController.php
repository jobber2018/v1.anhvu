...
class IndexController extends SuldeFrontController
{
    ...
    public function appSettingAction()
    {
        ...
        $result["zalo"]="0877 427 569";
        $result["subTitle"]="Chúng tôi ở đây để phục vụ bạn";
        $result["product_des"]="Cam kết bán hàng chính hãng, Zalo: 0877 427 569";
...
//        else $status=-1;
    ...
    private function setProductResult(Product $productItem)
    {
        ...
        $product["price"]=$productItem->getActivePrice()->getPrice();
...
//        $product["group_name"]=$productItem->getLabelName();
...
//        $datediff= floor($datediff / (60*60*24));
        ...
        if($productItem->getInventory()<10){
        ...
        else $product["ribbon"]=4;//"Bán chạy";
